...
const infos = [
  {
    ...
    description: "+91-8770689525",
  },
  {
    icon: <MailIcon color="primary" />,
    description: "info@minzor.com",
  },
];
...
const socialIcons = [
  {
    ...
    label: "Facebook",
    href: "https://www.facebook.com/TheMinzor/",
  },
  {
    icon: (
      <svg
    ...
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/minzor/",
  },
  {
    icon: (
      <svg
    ...
    label: "Twitter",
    href: "https://twitter.com/Minzor_",
  },
];

const LinkStyle = {
  background: "-webkit-linear-gradient(#ED1C24, #F15A24)",
        ...
        <Grid container spacing={isWidthUp("md", width) ? 10 : 5}>
          <Grid item xs={12} md={6} lg={4}>
            <Typography
              style={{
                fontSize: "2rem",
                background: "-webkit-linear-gradient(#f86d15, #fcc009)",
                "-webkit-background-clip": "text",
                "-webkit-text-fill-color": "transparent",
                padding: "10px 0px",
                textAlign: "center",
